...
const values = [
  {
    title: '发现问题',
    text: '统一查看设备、告警、任务与风险。',
  },
  {
    title: '推动处置',
    text: '把分析结果直接转成工单、复核项和升级动作。',
  },
  {
    title: '闭环交接',
    text: '未结项、责任人、回执与接收状态一屏可见。',
  },
]
  ...
  return (
    <div className="site-shell">
        ...
        <div className="hero-content compact">
          <div className="hero-copy">
            ...
            <p className="hero-text">
              面向班次值守、告警处置、工单执行与班组交接的工业协同产品原型。
            </p>
          ...
          <div className="hero-panel compact-panel">
            ...
            <div className="chip-row highlight-row">
              {highlights.map((item) => (
      ...
      <main>
        ...
        <section id="scenes" className="section alt-section">
          <div className="section-heading narrow">
          ...
          <div className="scene-grid single-line-grid">
            {scenes.map((scene) => (
              <article key={scene} className="scene-card simple-card">
                <h3>{scene}</h3>
              </article>
            ))}
          </div>
